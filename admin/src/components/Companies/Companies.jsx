...
const Companies = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        "https://job-portal-backend-gamma-two.vercel.app/https://job-portal-backend-gamma-two.vercel.app//api/company",
        formData,
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  const handleConfirmDelete = async () => {
    try {
      const token = localStorage.getItem("token");
      await axios.delete(
        `https://job-portal-backend-gamma-two.vercel.app/https://job-portal-backend-gamma-two.vercel.app//api/company/${pendingDeleteId}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
