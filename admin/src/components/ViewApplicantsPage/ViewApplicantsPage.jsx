...
const ViewApplicantsPage = () => {
    ...
    const fetchApplicants = async () => {
      ...
      try {
        ...
        const res = await fetch(
          `https://job-portal-backend-gamma-two.vercel.app/api/application/${jobId}/applicants`,
          {
            headers: {
  ...
  const handleViewResume = (resumeUrl, userId) => {
    if (!resumeUrl) return;
    const fullUrl = `https://job-portal-backend-gamma-two.vercel.app/api/user/resume/${userId}`;
