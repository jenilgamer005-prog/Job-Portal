...
const Dashboard = () => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const statsRes = await fetch(
          "https://job-portal-backend-gamma-two.vercel.app/api/job/admin/stats",
          {
        ...
        const jobsRes = await fetch(
          "https://job-portal-backend-gamma-two.vercel.app/api/job/admin/jobs",
          {
            headers: { Authorization: `Bearer ${token}` },
          },
        );
        ...
        if (jobsData.success) {
          const mappedJobs = jobsData.jobs.map((j) => ({
            ...
            logo: j.companyLogo?.startsWith("http")
              ? j.companyLogo
              : `https://job-portal-backend-gamma-two.vercel.app/${j.companyLogo || ""}`,
  ...
  const handleConfirmClose = async () => {
    ...
    try {
      const token = localStorage.getItem("token");
      const res = await fetch(`https://job-portal-backend-gamma-two.vercel.app/api/job/${jobId}/close`, {
        method: "PATCH",
        headers: {
