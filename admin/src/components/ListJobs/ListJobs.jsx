...
export default function ListJobs() {
    ...
    return {
      ...
      image:
        ...
        bJob.companyLogo?.startsWith("data:")
          ? bJob.companyLogo
          : `https://job-portal-backend-gamma-two.vercel.app/https://job-portal-backend-gamma-two.vercel.app/${bJob.companyLogo || ""}`,
      role: bJob.roleName,
  ...
  const fetchJobs = async () => {
    try {
      ...
      const res = await axios.get("https://job-portal-backend-gamma-two.vercel.app/https://job-portal-backend-gamma-two.vercel.app//api/job/admin/jobs", {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      const token = localStorage.getItem("token");
      const res = await axios.delete(`https://job-portal-backend-gamma-two.vercel.app/https://job-portal-backend-gamma-two.vercel.app//api/job/${id}`, {
        headers: { Authorization: `Bearer ${token}` },
      });
      if (res.data.success) {
  ...
  const handleSave = async (e) => {
    ...
    try {
      ...
      const res = await axios.put(
        `https://job-portal-backend-gamma-two.vercel.app/https://job-portal-backend-gamma-two.vercel.app//api/job/${editingJob.id}`,
        formDataToSend,
        {
          headers: {
