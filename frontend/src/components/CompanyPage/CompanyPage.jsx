        ...
        {featuredCompanies.length > 0 && (
          <div className="mb-8">
            <div className="flex items-center justify-between gap-3 mb-4">
              <div>
                <h2 className={s.featuredTitle}>Featured Companies</h2>
                <p className={s.featuredSubtitle}>
                  Companies added from the admin panel.
                </p>
              </div>
            </div>
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
              {featuredCompanies.map((company) => (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="group flex flex-col items-center gap-3 rounded-3xl border border-gray-200 bg-white p-4 shadow-sm transition hover:-translate-y-0.5 hover:shadow-lg"
                >
                  <div className="flex h-20 w-20 items-center justify-center overflow-hidden rounded-2xl bg-slate-100">
                    <img
                      ...
                      onError={(e) => {
                        e.currentTarget.src = `https://via.placeholder.com/160?text=${encodeURIComponent(
