    ...
    <footer className={s.footer}>
      <div className={s.footerInner}>
        ...
        <div className={s.grid}>
          ...
          <div>
            ...
            <ul className={s.linkList}>
              <FooterLink href="/jobs" icon={<ArrowRight className="w-4 h-4" />}>
                Find Jobs
              </FooterLink>
              <FooterLink href="/companies" icon={<Building className="w-4 h-4" />}>
                Companies
              </FooterLink>
              ...
              <FooterLink href="/contact" icon={<UserPen className="w-4 h-4" />}>
                Contact
              </FooterLink>
            </ul>
          </div>
        ...
        <div className={s.bottomFooter}>
          <img src={logo} alt="JobPortal" className={s.bottomLogo} />
          <span className={s.designedByText}>
            Created By Jenil Reshamwala & Tushar Jariwala
          </span>
        </div>
      </div>
    </footer>
