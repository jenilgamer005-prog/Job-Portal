...
export const footerStyles = {
  // ==================== Footer Container ====================
  footer:
    "bg-linear-to-b from-white to-blue-50 font-mono pt-6 sm:pt-8 md:pt-10 pb-6 border-t border-gray-200",
  footerInner: "max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-10",

  // ==================== Grid Layout ====================
  grid: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 sm:gap-6 md:gap-8 mb-6 md:mb-8",

  // ==================== Company Info Section ====================
  companySection: "space-y-3",
  ...
  // ==================== Section Headers ====================
  sectionHeader:
    "text-base sm:text-lg md:text-lg font-semibold text-gray-900 mb-4 pb-2 border-b border-blue-100 inline-block",
  linkList: "space-y-3 mt-3",

  // ==================== Contact Section ====================
  contactList: "space-y-3 mt-3",

  // ==================== Divider ====================
  divider: "border-t border-gray-200 my-4 md:my-6",
